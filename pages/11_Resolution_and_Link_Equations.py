...
st.write("Explore range/angular resolution, pulse volume, and one-way link power.")
...
st.caption("Variables: $P_t$ TX power (dBm), $G_t/G_r$ antenna gains (dBi), FSPL, $L_{tot}$ misc. losses.")
