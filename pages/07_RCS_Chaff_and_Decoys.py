...
st.markdown(
    r"""
    Scattering regions for simple and complex targets:
    ...
    * **Optical region:** geometric optics dominates; specular and edge diffraction drive \(\sigma\).
    ...
    Composite airframes mix tip, edge, cavity, and traveling-wave echoes. Fluctuation loss and Swerling cases model the resulting RCS spread.
    """
)
...
st.markdown(
    ...
    * **Active decoys** apply gain \(G_{amp}\) and retransmit: \(\sigma_{sim} \approx 39 + G_{amp} - 20\log_{10}(f_{MHz})\) dBsm.
...
with st.expander("Paste figure placeholders"):
    st.write("RCS aspect plots, retroreflector sketches, and chaff photos fit here.")
